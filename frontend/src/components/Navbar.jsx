...
import { IoHomeOutline, IoPeopleOutline, IoCalendarOutline, IoMailOutline } from "react-icons/io5";
...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className={cn(
          "fixed z-50 w-[95%] top-4 rounded-2xl -translate-x-1/2 left-1/2 border-b border-white/10 bg-transparent backdrop-blur-xl",
          "md:top-4 md:left-1/2 md:w-[65%] md:-translate-x-1/2 lg:rounded-full md:border"
        )}
      >
        <div className="flex h-16 items-center justify-between px-4 md:px-6">
          <Link to="/" className="flex items-center gap-2">
            <img src="/Logo.png" alt="Website Logo" width={45} height={45} />
            <span className="text-white">GDG TSEC</span>
          </Link>
